...
const applyJob=(e)=>{
    ...
    axios.post('http://localhost:8080/api/Company/add',apply)
    .then(
        response => {
            console.log(" successfully Applied", response.data);
            alert(` Successfully Applied fro job`);
...
return(
    <div className="container">
            <h3>Add Deatils For Applying to {a} Job</h3>
            <hr/>
            <form>
            ...
            <hr/>
            <Link to="/user/dashboard/search-job">Back</Link>
        </div>
